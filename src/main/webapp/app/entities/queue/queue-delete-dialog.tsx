...
export const QueueDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/queue' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="waitlineBackendApp.queue.delete.question">Are you sure you want to delete Queue {queueEntity.id}?</ModalBody>
      <ModalFooter>
