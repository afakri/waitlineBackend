...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './queue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUEUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_QUEUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_QUEUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_QUEUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_QUEUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_QUEUE actions', async () => {
      const expectedActions = [
        {
