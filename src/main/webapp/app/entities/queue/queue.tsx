...
import { getEntities } from './queue.reducer';
...
export const Queue = () => {
  ...
  return (
    <div>
      <h2 id="queue-heading" data-cy="QueueHeading">
        Queues
      ...
      <div className="table-responsive">
        {queueList && queueList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/queue/${queue.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/queue/${queue.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Queues found</div>
        )}
      </div>
      {totalItems ? (
        <div className={queueList && queueList.length > 0 ? '' : 'd-none'}>
