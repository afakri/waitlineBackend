...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './waiting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WAITING_LIST actions', async () => {
    ...
    it('dispatches FETCH_WAITING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WAITING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WAITING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WAITING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WAITING actions', async () => {
      const expectedActions = [
        {
